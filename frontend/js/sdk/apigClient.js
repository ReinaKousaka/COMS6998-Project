...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://oz0f40is34.execute-api.us-east-1.amazonaws.com/V1';
    ...
    apigClient.carsGet = function (params, body, additionalParams) {
        ...
        return apiGatewayClient.makeRequest(carsGetRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.carsPost = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        ...
        return apiGatewayClient.makeRequest(carsPostRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.carsOptions = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var carsOptionsRequest = {
        ...
        return apiGatewayClient.makeRequest(carsOptionsRequest, authType, additionalParams, config.apiKey);
    };
    ...
    apigClient.searchGet = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['user', 'q'], ['body']);
        
        var searchGetRequest = {
            verb: 'get'.toUpperCase(),
            path: pathComponent + uritemplate('/search').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, ['user', 'q']),
            body: body
        };
